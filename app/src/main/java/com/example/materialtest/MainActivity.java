    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.backup:
                ...
                break;
            case R.id.delete:
                Toast.makeText(MainActivity.this,"You Delete Backup",Toast.LENGTH_SHORT).show();
                break;
            case R.id.settings:
                Toast.makeText(MainActivity.this,"You Settings Backup",Toast.LENGTH_SHORT).show();
                break;
            default:
        }
        return true;
